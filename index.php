...
// selecciona los registros de servicios
$sentencia = $conexion->prepare("SELECT * FROM tbl_servicios");
$sentencia->execute();
$lista_servicios = $sentencia->fetchAll(PDO::FETCH_ASSOC);

// selecciona los registros de portafolio
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="assets/img/drum-kit-svgrepo-com.svg" alt="..." /></a>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Es Un Gusto Conocerte</div>
            <div class="masthead-heading text-uppercase">Bienvenido a nuestro estudio!</div>
